...
const { transformedData, first, rows, totalRecords, loading, fetchItems, onPageChange } = usePaginatedFetch('meeting', filters);
...
<template>
    <div className="grid">
        <div className="col-12">
            <div className="card">
                <h3>Manage Book Meetings</h3>
                <div class="card">
                    <Toolbar class="mb-4">
                        <template #start>
                            <NuxtLink to="/meeting/create">
                    ...
                    >
                        ...
                        <Column field="book" header="Book" filterMatchMode="startsWith" sortable>
                            ...
                            <template #body="{ data }">
                                <NuxtLink :to="`/meeting/${data.id}`">{{ data.book }}</NuxtLink>
                            </template>
                        </Column>
